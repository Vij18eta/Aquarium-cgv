...
void screen()
{
	...
	drawstring(210,425,0.0,"P E S Institute of technology and management ,Shivmogga",1);
		glColor3f(0.0,0.0,0.0);
	drawstring(245,385,0.0,"DEPARTMENT OF COMPUTER SCIENCE AND DESIGN",1);
	...
	drawstring(440,300,0.0,"AQUARIUM",1);
	  ...
	  drawstring(135,205,0.0," STUDENT NAME",0);
	  	glColor3f(0.0,0.0,0.0);
	drawstring(135, 205, 0.0, " STUDENT NAME", 0);
glColor3f(0.0, 0.0, 0.0); // Black color for names
drawstring(140, 170, 0.0, "Vijeta", 0);
drawstring(140, 135, 0.0, "Chandana", 0);
drawstring(140, 100, 0.0, "Deekshitha", 0);     // New name 1
drawstring(140,  65, 0.0, "Kishan", 0);   // New name 2
    // New name 3
glColor3f(1.0, 0.0, 0.0); // Reset to red after the names

		glColor3f(1.0,0.0,0.0);
	drawstring(710,205,0.0,"Under the Guidance of",0);
		glColor3f(0.0,0.0,0.0);
	drawstring(720,170,0.0,"Prof Kavya M",0);
		glColor3f(1.0,1.0,0.0);
	drawstring(406,95,0.0,"Academic Year 2025",0);
